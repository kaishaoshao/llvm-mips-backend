...
We will add a new target named Nova to the LLVM tree for the MIPS architecture. Like [Crafting Interpreters](https://craftinginterpreters.com), every line has an explanation in this series so you can follow along without needing to scour the internet for answers.
...
Since I am also new to LLVM, I am writing this for myself and others to learn about it. I hope you find it useful and interesting enough.